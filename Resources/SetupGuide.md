# AudioDaBitch: Detaillierte Audio-Einrichtung für Discord und xPilot

Diese Anleitung beschreibt das empfohlene Routing für macOS mit Discord, xPilot/VATSIM, BlackHole und AudioDaBitch.

## 1. BlackHole-Geräte installieren
...
Danach den Mac neu starten, falls die Geräte nicht sofort erscheinen.
...
Diese Geräte nicht verwenden. Sie können gelöscht oder umbenannt werden, damit sie nicht versehentlich ausgewählt werden.
...
## Variante mit Aggregate Device

Falls eine spätere Audio-Engine nur ein einziges Input-Gerät verwenden kann, dann ein Aggregate Device erstellen.
...
Für den Audiolimiter auf macOS gilt:
